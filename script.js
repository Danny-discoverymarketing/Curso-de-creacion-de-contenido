...
function getResourceWord(count) {
...
function renderSections() {
  ...
  resourceCount.textContent = `${filteredResources.length} ${getResourceWord(
  ...
  groupedResources.forEach((section) => {
    ...
    count.textContent = `${section.resources.length} ${getResourceWord(
